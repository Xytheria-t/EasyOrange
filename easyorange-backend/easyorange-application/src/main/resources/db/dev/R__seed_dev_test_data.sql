...
INSERT INTO `eo_user` (
    ...
    `sex`, `status`, `del_flag`, `email`, `phone`,
    `real_name`, `avatar`, `create_time`, `update_time`
) VALUES
(1,  'testuser',  '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '测试用户',   0, 'NORMAL', 0, 'testuser@example.com',    '13800138001', '张三',   'https://picsum.photos/seed/avatar1/100/100',  NOW() - INTERVAL 90 DAY, NOW()),
(2,  'admin',     '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '02', '管理员',     1, 'NORMAL', 0, 'admin@example.com',       '13800138002', '李管理', 'https://picsum.photos/seed/avatar2/100/100',  NOW() - INTERVAL 120 DAY, NOW()),
(3,  'liming',    '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '黎明',       1, 'NORMAL', 0, 'liming@example.com',      '13800138003', '黎明',   'https://picsum.photos/seed/avatar3/100/100',  NOW() - INTERVAL 60 DAY, NOW()),
(4,  'wangfang',  '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '小芳同学',   2, 'NORMAL', 0, 'wangfang@example.com',    '13800138004', '王芳',   'https://picsum.photos/seed/avatar4/100/100',  NOW() - INTERVAL 45 DAY, NOW()),
(5,  'zhaowei',   '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '赵伟',       1, 'NORMAL', 0, 'zhaowei@example.com',     '13800138005', '赵伟',   'https://picsum.photos/seed/avatar5/100/100',  NOW() - INTERVAL 30 DAY, NOW()),
(6,  'sunli',     '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '孙丽',       2, 'NORMAL', 0, 'sunli@example.com',       '13800138006', '孙丽',   'https://picsum.photos/seed/avatar6/100/100',  NOW() - INTERVAL 20 DAY, NOW()),
(7,  'zhouyang',  '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '周洋',       1, 'NORMAL', 0, 'zhouyang@example.com',    '13800138007', '周洋',   'https://picsum.photos/seed/avatar7/100/100',  NOW() - INTERVAL 15 DAY, NOW()),
(8,  'chenxiao',  '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '陈晓',       2, 'NORMAL', 0, 'chenxiao@example.com',    '13800138008', '陈晓',   'https://picsum.photos/seed/avatar8/100/100',  NOW() - INTERVAL 10 DAY, NOW()),
(9,  'lockeduser','$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '被锁定用户', 0, 'LOCKED', 0, 'locked@example.com',      '13800138009', '刘锁',   NULL,                                           NOW() - INTERVAL 5 DAY, NOW()),
(10, 'disableduser','$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK','01', '已禁用用户', 0, 'DISABLED', 0, 'disabled@example.com',    '13800138010', '吴禁',   NULL,                                           NOW() - INTERVAL 3 DAY, NOW()),
(11, 'huangjie',  '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '黄杰学长',   1, 'NORMAL', 0, 'huangjie@example.com',    '13800138011', '黄杰', 'https://picsum.photos/seed/avatar11/100/100', NOW() - INTERVAL 180 DAY, NOW()),
(12, 'liuyan',    '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '刘燕',       2, 'NORMAL', 0, 'liuyan@example.com',      '13800138012', '刘燕', 'https://picsum.photos/seed/avatar12/100/100', NOW() - INTERVAL 120 DAY, NOW()),
(13, 'wanghai',   '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '王海',       1, 'NORMAL', 0, 'wanghai@example.com',     '13800138013', '王海', 'https://picsum.photos/seed/avatar13/100/100', NOW() - INTERVAL 90 DAY, NOW()),
(14, 'zhangmei',  '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '张梅',       2, 'NORMAL', 0, 'zhangmei@example.com',    '13800138014', '张梅', 'https://picsum.photos/seed/avatar14/100/100', NOW() - INTERVAL 60 DAY, NOW()),
(15, 'liguang',   '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '李光',       1, 'NORMAL', 0, 'liguang@example.com',     '13800138015', '李光', 'https://picsum.photos/seed/avatar15/100/100', NOW() - INTERVAL 45 DAY, NOW()),
(16, 'xujia',     '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '许佳',       2, 'NORMAL', 0, 'xujia@example.com',       '13800138016', '许佳', 'https://picsum.photos/seed/avatar16/100/100', NOW() - INTERVAL 30 DAY, NOW()),
(17, 'qianlei',   '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '钱磊',       1, 'NORMAL', 0, 'qianlei@example.com',     '13800138017', '钱磊', 'https://picsum.photos/seed/avatar17/100/100', NOW() - INTERVAL 14 DAY, NOW()),
(18, 'hanxue',    '$2a$10$gxOyIzrDj4byMrfyopCwDOLOBdt.xlhDNjpbXDv.Au1gyApmKVDNK', '01', '韩雪',       2, 'NORMAL', 0, 'hanxue@example.com',      '13800138018', '韩雪', 'https://picsum.photos/seed/avatar18/100/100', NOW() - INTERVAL 7 DAY, NOW())
AS new
...
(1013, '哔哩哔哩大会员 剩余10个月<br><br>【权益】番剧、纪录片、电影等内容免广告观看<br><br>【剩余】10个月，付款后协助换绑到你的手机号<br><br>【交易】线上交易，虚拟商品不支持退款，下单前请确认需求', NOW(), NOW()),
(1014, 'Figma设计系统UI组件包 500+矢量<br><br>【内容】500+ 组件与图标：按钮、表单、导航、数据可视化等常用场景<br><br>【格式】.fig 源文件，可一键复制进自己的设计项目<br><br>【适合】UI 设计师与独立开发者快速搭产品原型', NOW(), NOW()),
(1015, 'Notion个人版会员 剩余8个月<br><br>【权益】个人版完整功能：无限页面、无限块、访客协作<br><br>【剩余】8个月，付款后转移会员时长到你的账号<br><br>【交易】线上交易，虚拟商品不支持退款，下单前请确认需求', NOW(), NOW())
AS new
ON DUPLICATE KEY UPDATE
...
-- ===================================================================
-- 12. 多图商品演示数据
--     目的：全库原本没有 3 张图的商品，商品详情页的图片轮播在 demo 里只有一格。
--     补充图片的 URL 复用同品类已有素材（新增外链可能失效，宁可重复）。
